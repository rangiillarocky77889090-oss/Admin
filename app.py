...
text= "💙💚❤️THIS WEB PAGE IS MADE BY Mr.Samar 💫💯🟥🟨🟧OWNER :- Mr.Samar ✨🍁🌹"; //h
string2array(text);
divserzeugen();
//document.write(text);
</script></div>
<p id='name'>           
        ...
        <body>
          <header class="header mt-4">
            <h1 class="mb-3">🚀 Samar✨</h1>
            <h3>OWNER BY Samar ❤️</h3>
          </header>
          ...
          <footer class="footer">
            <p>&copy; Developed by Samar 2024. All Rights Reserved.</p>
